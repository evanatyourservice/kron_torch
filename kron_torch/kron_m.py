    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                grad = p.grad
                # rms norm 
                grad = grad / (torch.linalg.norm(grad) + self._tiny)
                state = self.state[p]
                ...
                momentum_buffer = momentum_buffer.to(
                ...
                if do_update:
                    if group["use_grad_stats"] and self.momentum_count[p] > 0:
                        ...
                        update_grad = momentum_buffer if group["momentum_into_precond_update"] else grad
